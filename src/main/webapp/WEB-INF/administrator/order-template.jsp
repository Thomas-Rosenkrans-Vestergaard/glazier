...
<form class="main" method="POST">
    ...
    <fieldset>
        ...
        <div class="input-field col s12">
            <input id="customer_zip" type="number" class="validate" name="customer_zip" required="required" value="${order.getCustomerZip()}">

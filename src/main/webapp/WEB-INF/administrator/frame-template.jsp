...
<form method="POST" class="main">
    ...
    <div class="input-field col s12">
        <input id="price_per_m" type="number" class="validate" name="price_per_m" required="required" value="${frame.getPricePerMeter()}"/>
        <label for="price_per_m">Price per meter</label>
    </div>
